...
APELSERG.CONFIG.SET.PicSrc = ["applebloom.jpg", "applebloom2.jpg", "applebloom3.jpg"]; //-- заставка канвы
...
APELSERG.CONFIG.SET.ApplebloomNum = 500; //-- число
APELSERG.CONFIG.SET.ApplebloomSize = 30; //-- максимальный размер
...
APELSERG.MODEL.DATA.Applebloom = [];
...
APELSERG.MAIN.OnLoad = function () {
    ...
    APELSERG.CONFIG.PROC.Img.onload = function () {
        ...
        APELSERG.MODEL.DATA.Applebloom = APELSERG.MODEL.MakeApplebloom(APELSERG.CONFIG.SET.ApplebloomNum);
...
APELSERG.MAIN.Animation = function () {
    ...
    if (APELSERG.CONFIG.PROC.CntHandle == 1) APELSERG.MODEL.UpdateApplebloom();
